...
0. Download the river dataset from this [link](https://drive.google.com/drive/folders/1BN7roJyW6wZ-ibY5VkX-HSB80EFvyfJJ?usp=sharing) and place them at Stack-Overflood/used_data/rivers_final/
...
4. Set the desired OFFSET inside the BatchProcessParallel.py (default: 1 month, 15 days)

## How to run
```bash
python .\Stack-Overflood\BatchProcessParallel.py
```